...
This document provides information about various A-Frame components that can be integrated into the VRMOBDESK project.
...
- [A-Frame Arc Handy Controls Component](https://glitch.com/~aframe-arc-handy-controls-component) - A boilerplate project for getting started with VR and AR with AFrame that demonstrates many WebXR features.
