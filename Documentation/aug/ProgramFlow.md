...
1. User presses Space/taps Examine button while holding an object
2. The `toggleInspectionMode` method is called
...
7. User presses Space/taps Cancel to exit inspection mode
8. Camera and movement controls are re-enabled
9. The object is reattached to the camera
10. The interaction state changes back to 'holding'
