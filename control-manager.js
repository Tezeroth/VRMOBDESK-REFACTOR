...
AFRAME.registerComponent('control-manager', {
  init: async function() {
    ...
    // Wait for DeviceManager to be ready (simple delay for this example)
    // A more robust method would use events or promises from DeviceManager
    while (typeof DeviceManager === 'undefined' || !DeviceManager.hasOwnProperty('isVR')) {
